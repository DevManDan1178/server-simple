...
public:
  ...
  void test_broadcast(const std::string& msg) { broadcast(msg); }

protected:
  virtual void on_client_disconnected(boost::asio::ip::tcp::socket&) { return; }

  virtual void on_client_connected(boost::asio::ip::tcp::socket&) { return; }
};
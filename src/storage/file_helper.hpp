...
namespace file_helper {
     ...
     */
    inline static std::string get_file_path(const std::filesystem::path& parent_directory, const std::string& subdirectory_name, std::string_view filename) {
        ...
        try {
            ...
            throw std::runtime_error("Unable to create " + subdirectory_name + " directory for filename: " + std::string(filename) + " - " + std::string(e.what()));
        }
    }
}